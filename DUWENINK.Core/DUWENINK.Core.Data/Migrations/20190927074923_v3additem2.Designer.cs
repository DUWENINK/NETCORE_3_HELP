...
namespace DUWENINK.Core.Data.Migrations
{
    ...
    [Migration("20190927074923_v3additem2")]
    partial class v3additem2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DUWENINK.Core.Data.Entity.ItemEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DUWENINK.Core.Data.Entity.ItemGroupEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ItemGroupText")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DUWENINK.Core.Data.Entity.ItemEntity", b =>
                {
                    b.HasOne("DUWENINK.Core.Data.Entity.ItemGroupEntity", "ItemGroup")
                        .WithMany("Items")
                        .HasForeignKey("ItemGroupId");

                    b.HasOne("DUWENINK.Core.Data.Entity.ItemEntity", "ParentItem")
                        .WithMany("ChildItems")
            ...
            modelBuilder.Entity("DUWENINK.Core.Data.Entity.ItemGroupEntity", b =>
                {
                    b.HasOne("DUWENINK.Core.Data.Entity.ItemGroupEntity", "ParentItemGroup")
                        .WithMany()
