...
namespace DUWENINK.Core.Interfaces
{
    ...
    public interface IAreaService
    {
        ...
        /// <param name="filters">查询过滤参数</param>
        /// <returns></returns>
        Task<PagedResult<AreaOfferDto>> SearchPAreaOffersAsync(AreaOfferFilter filters);

        Task<string> AddAsync(AreaOfferDto dto);


        Task<decimal> GetOfferByAreaId(string areaId, string type);

        Task<IList<TreeDto>> FindAllByParentId(string parentId);
